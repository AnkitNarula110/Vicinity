      ...
      >
        ...
        <View style={[s.heroBanner, { borderColor: `${accent}22` }]}>
          ...
          <View style={s.heroInfo}>
            ...
            <View style={s.heroPills}>
              ...
              >
                ...
                <Text style={[s.distText, { color: accent }]}>
                  {" "}
          ...
          <View style={[s.matchRing, { borderColor: `${accent}55` }]}>
            <Text style={[s.matchPct, { color: accent }]}>
        ...
        <View style={s.card}>
          <View style={s.musicRow}>
            ...
            <View style={s.vinylWrap}>
              <Animated.View
                style={[s.vinyl, { transform: [{ rotate: spin }] }]}
              >
                <View style={[s.vinylCenter, { backgroundColor: accent }]} />
              </Animated.View>
              <Image
                source={{
                  uri: "https://i.scdn.co/image/ab67616d0000b273b5e1cf58a5be715be0d64db9",
                }}
                style={s.albumArt}
              />
            </View>
            <View style={s.musicMeta}>
              ...
              <View style={s.progressBg}>
                <View
                  style={[
                    s.progressFill,
                    { backgroundColor: accent, width: "35%" },
                  ]}
                />
                <View
                  style={[
                    s.progressThumb,
                    { backgroundColor: accent, left: "35%" },
                  ]}
                />
              </View>
            </View>
        ...
        <View style={s.tagsWrap}>
          {["Fred again..", "Back Bar", "2am drives", "Interstellar"].map(
            (t) => (
              <Tag key={t} text={t} />
            ),
          )}
        ...
        {!isNudged ? (
          <View style={s.nudgeRow}>
            ...
            <BouncyButton
              onTap={handleNudge}
              style={[s.nudgeBtn, { backgroundColor: accent }]}
            >
          ...
          <View style={[s.nudgeSent, { borderColor: `${accent}55` }]}>
            <Ionicons
              ...
              color={accent}
            />
            <Text style={[s.nudgeSentText, { color: accent }]}>
              Nudge sent — waiting for them
            </Text>
          </View>
        )}
